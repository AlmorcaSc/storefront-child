...
# */
#require get_stylesheet_directory() . '/inc/jetpack/jetpack.php';
#
#/**
# * Welcome screen
# */
#if ( is_admin() ) {
#	require get_stylesheet_directory() . '/inc/admin/welcome-screen/welcome-screen.php';
#}
#
#/**
...
#	require get_stylesheet_directory() . '/inc/woocommerce/template-tags.php';
#	require get_stylesheet_directory() . '/inc/woocommerce/integrations.php';
#}
